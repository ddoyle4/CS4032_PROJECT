...
/* package file-system-api-0.1.0.0 */
#define VERSION_file_system_api "0.1.0.0"
#define MIN_VERSION_file_system_api(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "lock-service-0.1.0.0-FISXVvz8Jqt9DZrKXe1POs"

#define CURRENT_PACKAGE_KEY "lock-service-0.1.0.0-FISXVvz8Jqt9DZrKXe1POs"
