...
/* package editor-0.1.0.0 */
#define VERSION_editor "0.1.0.0"
#define MIN_VERSION_editor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "editor-0.1.0.0"

#define CURRENT_PACKAGE_KEY "editor-0.1.0.0"
